...
//
  ...
  #define HEATER_CHAMBER_PIN      PA1   // Required heater on/off pin (example: SKR 1.4 Turbo HE1 plug)
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        4000 // (seconds)
 ...
 */
  ...
  #define THERMAL_PROTECTION_CHAMBER_PERIOD    4000 // (seconds)
...
#define HOMING_BUMP_DIVISOR { 2, 2, 2, 2, 5}       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 50*60, 4*60, 4*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//#if AXIS_IS_TMC_CONFIG(I2)
 //   #define I2_CURRENT      1200
 //   #define I2_CURRENT_HOME I_CURRENT
 //   #define I2_MICROSTEPS    16
  //  #define I2_RSENSE         0.11
 //   #define I2_CHAIN_POS     -1
    //#define I2_INTERPOLATE  true
    //#define I2_HOLD_MULTIPLIER 0.5
 // #endif
...
//
    ...
    #define J_CURRENT      1400
    #define J_CURRENT_HOME J_CURRENT
    #define J_MICROSTEPS    16
    #define J_RSENSE         0.11
    #define J_CHAIN_POS     -1
    //#define J_INTERPOLATE  true
    //#define J_HOLD_MULTIPLIER 1
  #endif
...
#define LASER_FEATURE
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
    ...
    */
    #define LASER_SAFETY_TIMEOUT_MS     10000   // (ms)
