...
//#undef I_STEP_WRITE
//#undef I_DIR_WRITE
//#undef I_ENABLE_WRITE

//#define I_STEP_WRITE(v)    do { WRITE(PF9, v); WRITE(PE2, v); } while(0)
//#define I_DIR_WRITE(v)     do { WRITE(PF10, v); WRITE(PE3, v); } while(0)
//#define I_ENABLE_WRITE(v)  do { WRITE(PG2, v); WRITE(PD4, v); } while(0)

//#define I2_STEP_WRITE(v)    WRITE(PE2, v)
//#define I2_DIR_WRITE(v)     WRITE(PE3, v)
//#define I2_ENABLE_WRITE(v)  WRITE(PD4, v)
...
#if HAS_I_AXIS
#define I_APPLY_DIR(v,Q) I_DIR_WRITE(v)  //REMOVE THIS WHEN IMPLEMEMNTING UDAY OK
#define I_APPLY_STEP(v,Q) I_STEP_WRITE(v)  // REMOVE THIS WHEN IMPLEMENTING UDAY OK


//uday ok
//#define I_APPLY_DIR(v,Q)  do { I_DIR_WRITE(v);  I2_DIR_WRITE(v);  } while(0)
//#define I_APPLY_STEP(v,Q) do { I_STEP_WRITE(v); I2_STEP_WRITE(v); } while(0)
...
// UDAY OK
//#if PIN_EXISTS(I2_ENABLE)
//  I2_ENABLE_INIT();
//  if (!I_ENABLE_ON) I2_ENABLE_WRITE(HIGH);
...
//uday OK
//SET_OUTPUT(PE2); // I2 STEP
 //SET_OUTPUT(PE3); // I2 DIR
 // SET_OUTPUT(PD4); // I2 ENABLE
  //
#endif
