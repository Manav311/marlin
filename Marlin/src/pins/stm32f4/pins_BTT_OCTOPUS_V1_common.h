...
#define TEMP_CHAMBER_PIN                    PF6   // TH2
#define TEMP_3_PIN                          PF7   // TH3

//
// Heaters / Fans
//
#define HEATER_BED_PIN                      PA3   // BED HEATER 
#define HEATER_CHAMBER_PIN                  PA1   // LASER ENA
#define SPINDLE_LASER_PWM_PIN               PD15  // LASER PWM
#define SPINDLE_LASER_ENA_PIN               PB10  // Heater2
#define HEATER_0_PIN                        PA2  // BAND HEATER PRINT CHMABER
