...
#define HEATER_4_MAXTEMP 165
#define HEATER_5_MAXTEMP 165
#define HEATER_6_MAXTEMP 165
#define HEATER_7_MAXTEMP 165
#define BED_MAXTEMP      140
#define CHAMBER_MAXTEMP  140
...
#define PID_MAX    110      // Limit hotend current while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80.70 , 398.11, 401.50, 400, 400}
...
#define Z_PROBE_FEEDRATE_FAST (4000*60)
...
#define Z_AFTER_HOMING  205      // (mm) Height to move to after homing Z
...
#define I_MIN_POS 0
#define I_MAX_POS 280   
#define J_MIN_POS 0
#define J_MAX_POS 505  
//#define K_MIN_POS 0
//#define K_MAX_POS 50
//#define U_MIN_POS 0
//#define U_MAX_POS 50
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (25*30), (25*30), (25*30) }
